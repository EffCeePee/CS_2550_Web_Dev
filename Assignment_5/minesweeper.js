...
function animation() {
    var _movement = document.getElementById("animantion");
    var _animantionHTML = "<p class ='flying'> Do you want to see the car race across the screen?</p> <p class ='flying'> If this was your dream car what would it be?  <select id ='selection'> <option value='ford'>Ford</option> <option value='buick'>Buick</option> <option value='chevy'>Chevy</option><option value='wagon'>Wagon</option></select> </br> </p></br><p class ='flying'> Milliseconds Per Frame:  <input id='milliseconds' type='text' size='5' value='10'> Distance Moved: <input id='distance' type='text' size='5' value='20'></p> </br> <button type='button' onclick = 'start()'> start </button></p>"
